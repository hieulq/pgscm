...
class FarmerForm(FlaskForm):
    ...
    gender = SelectField(__('Gender'), validators=[data_required], coerce=str)
    type = SelectField(__('Type'), validators=[data_required], coerce=str)
    group = SelectField(__('Group'), validators=[data_required], coerce=str)
