...
def upgrade():
    ...
    op.create_table('farmer',
                    ...
                    sa.Column('gender',
                              ...
                              nullable=True),
                    sa.Column('type',
                              sa.Enum('member', 'reviewer',
                                      'leader', 'deputy_leader',
                                      'counter', name='farmertype'),
                              nullable=True),
